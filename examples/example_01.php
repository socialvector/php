 ...
 *
 * Set the Authorization callback URL to https://path/to/socialvector/examples/example_01.php.
 ...
 * and can be used for the callback. Example: 'callback' => SocialVector\HttpClient\Util::getCurrentUrl()
 *
...
$config = [
    'callback' => 'https://path/to/socialvector/examples/example_01.php', // or SocialVector\HttpClient\Util::getCurrentUrl()
...
$github = new SocialVector\Provider\GitHub($config);
 ...
 *
 * Calling getUserProfile returns an instance of class SocialVector\User\Profile which contain the
 ...
 *
 * Social Vector use exceptions extensively and it's important that these exceptions
 ...
 */
catch (SocialVector\Exception\HttpClientFailureException $e) {
 ...
 */
catch (SocialVector\Exception\HttpRequestFailedException $e) {
