...
<head>
    ...
    <script>
        function auth_popup(provider) {
            // replace 'path/to/socialvector' with the real path to this script
            var authWindow = window.open('https://path/to/socialvector/examples/example_07/callback.php?provider=' + provider, 'authWindow', 'width=600,height=400,scrollbars=yes');
