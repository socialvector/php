...
use SocialVector\Exception\InvalidAuthorizationStateException;
use SocialVector\Exception\InvalidAuthorizationCodeException;
...
abstract class OAuth2 extends AbstractAdapter implements AdapterInterface
{
     ...
     *
     * @throws \SocialVector\Exception\InvalidAuthorizationCodeException
     * @throws \SocialVector\Exception\AuthorizationDeniedException
     */
