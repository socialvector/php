...
use SocialVector\Exception\InvalidOpenidIdentifierException;
...
use SocialVector\Thirdparty\OpenID\LightOpenID;
...
abstract class OpenID extends AbstractAdapter implements AdapterInterface
{
    ...
    protected function fetchUserProfile($openidAttributes)
    {
        ...
        $userProfile->postalCode = $data->get('contact/postalCode/home');
