...
use SocialVector\Exception\InvalidApplicationCredentialsException;
use SocialVector\Exception\AuthorizationDeniedException;
use SocialVector\Exception\InvalidOauthTokenException;
use SocialVector\Exception\InvalidAccessTokenException;
use SocialVector\Data;
use SocialVector\HttpClient;
use SocialVector\Thirdparty\OAuth\OAuthConsumer;
use SocialVector\Thirdparty\OAuth\OAuthRequest;
use SocialVector\Thirdparty\OAuth\OAuthSignatureMethodHMACSHA1;
use SocialVector\Thirdparty\OAuth\OAuthUtil;
...
abstract class OAuth1 extends AbstractAdapter implements AdapterInterface
{
     ...
     *
     * @return \SocialVector\Data\Collection
     * @throws InvalidOauthTokenException
     */
     ...
     * Social Vector will consider any HTTP status code that is different than '200 OK' as an ERROR.
     *
     * @param string $url
     * @param string $method
     * @param array $parameters
