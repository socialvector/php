...
/**
 * Social Vector default Http client
 */
class Curl implements HttpClientInterface
{
    ...
    protected $curlOptions = [
        ...
        // phpcs:ignore
        CURLOPT_USERAGENT => 'Hybridauth, PHP Social Authentication Library (https://github.com/socialvector/php)',
    ];
