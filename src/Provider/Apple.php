...
use SocialVector\Exception\HttpClientFailureException;
use SocialVector\Exception\HttpRequestFailedException;
 ...
 *   ];
 *
 *   $adapter = new SocialVector\Provider\Apple($config);
 *
 *   try {
...
class Apple extends OAuth2
{
    ...
    public function getUserProfile()
    {
        ...
        if (!$verifyTokenSignature) {
            ...
            // https://github.com/socialvector/php/issues/1095#issuecomment-626479263
