...
/**
 * Spaces OAuth2 provider adapter.
 *
 * Spaces doesn't use standard OAuth refresh tokens.
...
class Spaces extends OAuth2
{
     ...
     * {@inheritdoc}
     */
    protected $apiBaseUrl = 'https://spacesnet.com/app_api';

    /**
     * {@inheritdoc}
     */
    protected $authorizeUrl = 'https://spacesnet.com/oauth';

    /**
     * {@inheritdoc}
     */
    protected $accessTokenUrl = 'https://spacesnet.com/authorize';

    /**
     * {@inheritdoc}
     */
    protected $apiDocumentation = 'https://developers.spacesnet.com/docs/spaces-login/overview';

    /**
     * @var string Profile URL template as the fallback when no `link` returned from the API.
     */
    protected $profileUrlTemplate = 'https://spacesnet.com/%s';
    ...
    protected function initialize()
    {
        ...
        // Require proof on all Spaces api calls
        // https://developers.spacesnet.com/docs/graph-api/securing-requests#appsecret_proof
     ...
     * @throws \SocialVector\Exception\HttpClientFailureException
     * @throws \SocialVector\Exception\HttpRequestFailedException
     * @throws \SocialVector\Exception\InvalidAccessTokenException
     */
    ...
    public function getUserProfile()
    {
        ...
        $userProfile->middleName = $data->get('middle_name');
        ...
        // Fallback for profile URL in case Spaces does not provide "pretty" link with username.
     ...
     *
     * https://developers.spacesnet.com/docs/apps/faq#unable_full_friend_list
     */
