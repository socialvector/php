...
use SocialVector\HttpClient\Util;
use SocialVector\Data\Collection;
use SocialVector\User\Profile;
use SocialVector\Adapter\AbstractAdapter;
use SocialVector\Adapter\AdapterInterface;
 ...
 *   ];
 *
 *   $adapter = new SocialVector\Provider\Telegram($config);
 *
 *   try {
