<?php
/**
 * Basic autoloader for Social Vector library which you may use as it is or as a template
...
if (version_compare(PHP_VERSION, '5.4.0', '<')) {
    throw new Exception('Social Vector PHP 1 requires PHP version 5.4 or higher.');
}
