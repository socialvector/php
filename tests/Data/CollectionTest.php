...
namespace SocialVectorTest\SocialVector\Data;

use SocialVector\Data\Collection;
...
class CollectionTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function test_instance_of()
    {
        ...
        $this->assertInstanceOf('\\SocialVector\\Data\\Collection', $collection);
    }
    ...
    public function test_filter()
    {
        ...
        $this->assertInstanceOf('\\SocialVector\\Data\\Collection', $collection->filter('id'));
        $this->assertInstanceOf('\\SocialVector\\Data\\Collection', $collection->filter('slugs'));
        $this->assertInstanceOf('\\SocialVector\\Data\\Collection', $collection->filter('_non_existant_'));
